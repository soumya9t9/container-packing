...
var viewModel;
var itemMaterial;
// var OrbitControls = requirejs("./vendor/orbit-controls");
// require(['orbit-controls'], function (OrbitControls) {
async function PackContainers(request) {
	return $.ajax({
		url: '/data/packageingsample.json',
		type: 'POST',
		data: request,
...
$(document).ready(() => {
	...
	const aPR =  {
        ...
        "PackTimeInMilliseconds": 12,
        "PercentContainerVolumePacked": 15.74,
        "PercentItemVolumePacked": 100,
        "UnpackedItems": []
      } 
	setTimeout(() => {
		let vm = ViewModel();
		vm.ShowPackingView(aPR);
	}, 1100);
});
// });